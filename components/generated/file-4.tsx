...
export const TagsManager = memo(function TagsManager({ tags, onAddTag, onRemoveTag }: TagsManagerProps): JSX.Element {
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
      ...
      <div className="flex mb-4">
        ...
        <button
          ...
          className="ml-2 px-4 py-2 bg-accent hover:bg-green-700 text-white rounded-lg"
        >
          Add
        </button>
      </div>
